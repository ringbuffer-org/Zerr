...
class ZerrEnvelopes {
  public:
    ...
    int numOutlet; /**< number of outlets: assgined according to the speaker
                      configuration*/
    /**
     * @brief create a new zerr_envelopes instance
     * @param systemCfgs puredata basic system configuration: sample_rate,
     * block_size
     * @param selectionMode the corresponding mode of the envelope generator to
     * the control signal: trigger & trajectory
  ...
  private:
    ...
    zerr::EnvelopeGenerator*
        envelopeGenerator; /**< pointer to the Zerr EnvelopeGenerator object */
