...
class FeatureExtractor {
  public:
    ...
    /**
     * Run algorithm on the signal in the input buffer and update the output
     * buffer
     */
  ...
  protected:
    Samples x; /**< input data in t_samples type, the base type of t_blockIn,
                  t_audioBuf, t_specBuf*/
